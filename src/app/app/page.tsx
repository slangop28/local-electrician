                ...
                <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link href="/electrician">
                            <Button variant="primary" size="sm" className="hidden sm:block">Join as Technician</Button>
                        </Link>
                    </div>
                </div>
            </header>
                                    ...
                                    <span className={cn(
                                        ...
                                        activeRequest.status === 'NEW' ? "bg-amber-100 text-amber-700" :
                                            activeRequest.status === 'ACCEPTED' ? "bg-blue-100 text-blue-700" :
                                                activeRequest.status === 'SUCCESS' ? "bg-emerald-100 text-emerald-700" :
                                                    "bg-gray-100 text-gray-700"
                                    )}>
                                        {activeRequest.status === 'SUCCESS' ? 'Service Completed' : activeRequest.status === 'ACCEPTED' ? 'Booking Confirmed' : 'Finding Technician...'}
                                    </span>
                                </div>
